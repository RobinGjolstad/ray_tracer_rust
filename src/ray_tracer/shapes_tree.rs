...
use super::utils::tree::{Node, NodeData};
...
type ObjectData = NodeData<BaseShape>;

/// A node in the tree.
///
/// This will later be renamed to `Object`.
/// Object will be renamed to `Shape`.
type ObjectNode = Node<BaseShape>;
