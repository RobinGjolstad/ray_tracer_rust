...
mod tests {
    ...
    fn shade_hit_is_given_an_intersection_in_shadow() {
        ...
        let r = Ray::new(new_point(0.0, 0.0, 5.0), new_vector(0.0, 0.0, 1.0));
        let i = Intersection::new(4.0, Arc::new(s2));
        let binding = Intersections::new(&[i.clone()]);
        let comps = prepare_computations(&i, &r, &binding);
        let c = w.shade_hit(&comps, 1);
    ...
    fn the_refracted_color_with_an_opaque_surface() {
        ...
        let xs = Intersections::new(&[
            ...
            Intersection::new(6.0, Arc::new(shape)),
        ]);
    ...
    fn the_refracted_color_with_a_refracted_ray() {
        ...
        let xs = Intersections::new(&[
            ...
            Intersection::new(0.4899, Arc::new(B)),
            Intersection::new(0.9899, Arc::new(A)),
        ]);
    ...
    fn shade_hit_with_a_transparent_material() {
        ...
        let xs = Intersections::new(&[Intersection::new(2.0_f64.sqrt(), Arc::new(floor))]);
        let comps = prepare_computations(&xs.list[0], &r, &xs);
